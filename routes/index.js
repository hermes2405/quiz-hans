...
router.post('/user',  upload_user.single("imagen"), userController.create);     // registrar usuario
router.get('/user/:userId(\\d+)/edit',  sessionController.loginRequired, userController.ownershipRequired, upload_user.single("imagen"), userController.edit);     // editar información de cuenta
...
router.post('/quizes/create',              sessionController.loginRequired, upload_quizes.single("imagen"), quizController.create);
router.get('/quizes/:quizId(\\d+)/edit',   sessionController.loginRequired, quizController.ownershipRequired, quizController.edit);
router.put('/quizes/:quizId(\\d+)',        sessionController.loginRequired, quizController.ownershipRequired, upload_quizes.single("imagen"), quizController.update);
...
router.delete('/quizes/:quizId(\\d+)/comments/:commentId(\\d+)/destroy', sessionController.loginRequired, quizController.ownershipRequired, commentController.destroy)
// Estadisticas
